...
SELECT ПОТРЕБИТЕЛЬ.НАЗВАНИЕ, ПОТРЕБИТЕЛЬ.`СКИДКА, %`, ПОСТАВЩИК.ФАМИЛИЯ, ЗАКАЗ.`СУММА, РУБ` FROM ПОТРЕБИТЕЛЬ, ПОСТАВЩИК, ЗАКАЗ WHERE ЗАКАЗ.ПОСТАВЩИК = 2 HAVING SUM(ЗАКАЗ."СУММА, РУБ") > 5000;
